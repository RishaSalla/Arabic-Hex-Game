...
function getNeighbors(r,c){
    ...
    // 🛑 التعديل: عكس منطق الإزاحة ليتناسب مع البناء الفعلي
    if(isOdd){ // نستخدم منطق الصفوف الزوجية لتوصيل الصفوف الفردية
        potential=[[r,c-1],[r,c+1],[r-1,c-1],[r-1,c],[r+1,c-1],[r+1,c]];
    } else{ // نستخدم منطق الصفوف الفردية لتوصيل الصفوف الزوجية
        potential=[[r,c-1],[r,c+1],[r-1,c],[r-1,c+1],[r+1,c],[r+1,c+1]];
    }
    
    // الفلترة النهائية (لم يتم تغييرها)
