...
    const isOdd = r%2!==0; // الصف فردي (1, 3, 5, 7)
    let potential=[];
    
    // 🔄 التعديل: عكس منطق الإزاحة (تجربة الحالة المعاكسة)
    if(isOdd){ 
        // الآن يستخدم منطق الصفوف الزوجية لتوصيل الصفوف الفردية
        potential=[[r,c-1],[r,c+1],[r-1,c-1],[r-1,c],[r+1,c-1],[r+1,c]];
    } else{
        // الآن يستخدم منطق الصفوف الفردية لتوصيل الصفوف الزوجية
        potential=[[r,c-1],[r,c+1],[r-1,c],[r-1,c+1],[r+1,c],[r+1,c+1]];
    }
    
    // الفلترة النهائية (لم يتم تعديلها، وهي تسمح بالاتصال بالحدود)
